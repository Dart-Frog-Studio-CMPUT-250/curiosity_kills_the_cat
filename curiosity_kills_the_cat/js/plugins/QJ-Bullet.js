 ...
 *   });
 *
 *   e.g:change the value of Action and Anim.
 *
 *   QJ.BL.Shoot({
 *    Action:["SS[A,true]"],
 *    Anim:1
  ...
  (function (t, i) {
    ...
    function o(t) {
      return (
        ...
        (this.next.value - this.current.value) * t +
          this.current.value
      );
    }
    function l(i) {
          ...
          (s.prototype.init = function () {
            (this.age = 0),
              ...
              (this.rotationAcceleration *=
                t.ParticleUtils.DEG_TO_RADS),
              (this.alpha = this.alphaList.current.value),
              (this.scale.x = this.scale.y =
                this.scaleList.current.value),
              ...
              (this._doAcceleration =
                0 !== this.acceleration.x ||
                0 !== this.acceleration.y),
            ...
            (this.tint = t.ParticleUtils.combineRGBComponents(
              i.r,
              i.g,
              i.b
            )),
          ...
          (s.prototype.update = function (i) {
              ...
              (this.ease &&
                (e =
                  4 === this.ease.length
                    ...
                    : this.ease(e)),
              this._doAlpha &&
                (this.alpha = this.alphaList.interpolate(e)),
              this._doScale)
            ) {
              var s =
                this.scaleList.interpolate(e) * this.scaleMultiplier;
            ...
            if (this._doNormalMovement) {
              ...
              if (this._doSpeed) {
                ...
                (r = this.velocity.x * i), (n = this.velocity.y * i);
              (this.position.x += r), (this.position.y += n);
            }
            if (
              (this._doColor &&
                (this.tint = this.colorList.interpolate(e)),
              0 !== this.rotationAcceleration)
            ) {
              var p =
                this.rotationSpeed + this.rotationAcceleration * i;
              ...
              if (Array.isArray(t[0]))
                for (var i = 0; i < t.length; ++i)
                  for (
                    ...
                    var n = e[r];
                    this.segments.push({ p1: s, p2: n, l: 0 }),
                      (s = n);
                  }
              else
      ...
      y = (function () {
        ...
        return (
          ...
          Object.defineProperty(e.prototype, "particleConstructor", {
            ...
            set: function (t) {
              if (t !== this._particleConstructor) {
                ...
                for (var i = this._poolFirst; i; i = i.next)
                  i.destroy();
                (this._poolFirst = null),
                  this._origConfig &&
                    this._origArt &&
            ...
            if (e && r) {
              ...
              a && (a.x || a.y)
                ...
                (this.particleBlendMode =
                  t.ParticleUtils.getBlendMode(r.blendMode)),
                r.ease
                  ? (this.customEase =
          ...
          (e.prototype.update = function (t) {
            if (
              (this._autoUpdate &&
                (t = t / i.settings.TARGET_FPMS / 1e3),
              this._parent)
            ) {
              var e, s, r, n, a;
                      ...
                      for (
                        ...
                        if (
                          ...
                          this._poolFirst
                            ? ((m = this._poolFirst),
                              (this._poolFirst =
                                this._poolFirst.next),
                              (m.next = null))
                            : (m = new this.particleConstructor(
                                this
                              )),
          ...
          (e.prototype._spawnRect = function (i, e, s) {
            this.minStartRotation === this.maxStartRotation
              ...
              : (i.rotation =
                  ...
                  this.rotation),
              (x.x =
                Math.random() * this.spawnRect.width +
                this.spawnRect.x),
              (x.y =
                Math.random() * this.spawnRect.height +
                this.spawnRect.y),
              0 !== this.rotation &&
          ...
          (e.prototype._spawnRing = function (i, e, s) {
            ...
            this.minStartRotation === this.maxStartRotation
              ...
              r.minRadius !== r.radius
                ? (x.x =
                    Math.random() * (r.radius - r.minRadius) +
                    r.minRadius)
                : (x.x = r.radius),
              (x.y = 0);
          ...
          (e.prototype.cleanup = function () {
            ...
            for (t = this._activeParticlesFirst; t; t = i)
              (i = t.next),
                this.recycle(t),
                t.parent && t.parent.removeChild(t);
            (this._activeParticlesFirst = this._activeParticlesLast =
              null),
              (this.particleCount = 0);
          }),
          (e.prototype.destroy = function () {
            ...
            for (var i = this._poolFirst; i; i = t)
              (t = i.next), i.destroy();
            this._poolFirst =
              this._parent =
              this.particleImages =
          ...
          (e.prototype.init = function () {
            this.Particle_init(),
              ...
              this.framerate < 0 &&
                ...
                (this.framerate =
                  this.textures.length / this.duration));
          }),
        ...
        return (
          ...
          (e.prototype.setChildIndex = function (t, i) {
            ...
            if (
              ...
              this._firstChild === t &&
                (this._firstChild = t.nextChild),
              this._lastChild === t &&
                (this._lastChild = t.prevChild),
              (t.nextChild = null),
              (t.prevChild = null),
              this._firstChild)
            )
          ...
          (e.prototype.removeChild = function () {
            ...
            if (t.length > 1)
              ...
              (s.parent = null),
                ...
                this._firstChild === s &&
                  (this._firstChild = s.nextChild),
                this._lastChild === s &&
                  (this._lastChild = s.prevChild),
                (s.nextChild = null),
                (s.prevChild = null),
                --this._childCount,
                this._boundsID++,
          ...
          (e.prototype.removeChildAt = function (t) {
            ...
            return (
              ...
              this._firstChild === i &&
                (this._firstChild = i.nextChild),
              this._lastChild === i &&
                (this._lastChild = i.prevChild),
              (i.nextChild = null),
              (i.prevChild = null),
              --this._childCount,
              this._boundsID++,
          ...
          (e.prototype.getLocalBounds = function (t, e) {
            void 0 === e && (e = !1);
            var s = i.DisplayObject.prototype.getLocalBounds.call(
              this,
              t
            );
            if (!e) {
...
if (!SATVector) {
  ...
  SATPolygon.prototype.getAABBAsBox = function () {
    ...
    return new SATBox(
      this["pos"].clone().add(new SATVector(xMin, yMin)),
      xMax - xMin,
      yMax - yMin
    );
  };
...
(() => {
  ...
  const PresetText = (() => {
    ...
    for (let i = 0; i < presetText.length; i++) {
      ...
      if (detial.content2.length > 0)
        stringCon = stringCon + "+" + eval(detial.content2);
      if (detial.content3.length > 0)
        stringCon = stringCon + "+" + eval(detial.content3);
      list[String(detial.name)] = eval(
        "(function(){" + stringCon + "})"
      );
    }
    return list;
  ...
  const Preset = (() => {
    ...
    for (let i = 0; i < preset.length; i++) {
      ...
      list[String(detial.name)] = {
        ...
        z: detial.z,
        scaleX: isNaN(Number(detial.scaleX))
          ? detial.scaleX
          : Number(detial.scaleX),
        scaleY: isNaN(Number(detial.scaleY))
          ? detial.scaleY
          : Number(detial.scaleY),
        //======================================
        ...
        Speed: isNaN(Number(detial.Speed))
          ? detial.Speed
          : Number(detial.Speed),
        Max: isNaN(Number(detial.Max))
          ? detial.Max
          : Number(detial.Max),
        ...
        Opacity: isNaN(Number(detial.Opacity))
          ? detial.Opacity
          : Number(detial.Opacity),
        ...
        WaitBaseOnSpeed: isNaN(Number(detial.WaitBaseOnSpeed))
          ? detial.WaitBaseOnSpeed
          : Number(detial.WaitBaseOnSpeed),
        LMD: eval(detial.LMD),
        Bit: eval(detial.Bit),
  ...
  const tileSize = 48;
  let QJBInter = null;
  let forBidDestination =
    eval(parameters["forBidDestination"]) || false;
  let textureSave = {};
  const offsetGY = eval(parameters["offsetGY"]);
  let showBox = eval(parameters["showBox"]);
  const regionShow = eval(parameters["regionShow"]).map(
    (item, index, ary) => {
  ...
  const terrainShow = eval(parameters["terrainShow"]).map(
    (item, index, ary) => {
      if (item.length == 0) return [];
      let detail = item.split("|");
      return [Number(detail[0]), detail[1]];
  ...
  Game_QJBullet.prototype.setBase = function () {
    ...
    this.bulletMode = 0;
    this.rotationAuto =
      this.data.RotationAuto >= 0
        ? (this.data.RotationAuto * Math.PI) / 180
        : -1;
    ...
    //===============================================
    if (
      typeof this.data.rTRotation == "string" &&
      this.data.rTRotation.length > 0
    ) {
      this.rTRotationManager = {};
      let datas = this.data.rTRotation.split("~");
      for (let i = 0, l = datas.length; i < l; i++) {
        let data = datas[i].split("|");
        this.rTRotationManager[Number(data[0])] =
          (Number(data[1]) * Math.PI) / 180;
      }
    }
    //===============================================
    ...
    if (this.afterImage.length > 0) {
      this.afterImage[0] = new QJFrame(
        "afterImageColor",
        this.afterImage[0],
        1
      );
      this.afterImage[1] = new QJFrame(
        "afterImageOpacity",
        this.afterImage[1],
        0,
        true
      );
      this.afterImage[3] = new QJFrame(
        "afterImageWidth",
        this.afterImage[3],
        0,
        true
    ...
    if (typeof this.data.WaitBaseOnSpeed == "string") {
      ...
      for (let i = 0, l = datas.length; i < l; i++) {
        let data = datas[i].split("|");
        this.WaitBaseOnSpeedManager[Number(data[0])] = Number(
          data[1]
        );
      }
  ...
  Game_QJBullet.prototype.setOthers = function () {
    ...
    if (typeof this.bitmap == "object") {
      ...
      if (data[0] == 0) {
        let tar =
            data[1] == -1 ? $gamePlayer : $gameMap.event(data[1]),
          sp = null;
        if (!tar) {
          this.setDirectDead();
          return;
        }
        for (let i of SceneManager._scene._spriteset
          ._characterSprites) {
          if (i._character == tar) {
            sp = i;
            break;
    ...
    if ([1, 2, 3, 4, 7].includes(this.moveType[0]))
      this.maxRotation = (this.moveType[1] * Math.PI) / 180;
    //===============================================
    if (this.moveType[0] == 9) {
      this.rotationMove = QJ.BL.dealInitialRotation(
    ...
    //===============================================
    if (
      this.data.MoveType[0] == 9 ||
      this.data.MoveType[0] == 8 ||
      this.boxType[0] != 0
    ) {
      this.ReBound = 0;
    }
  ...
  Game_QJBullet.prototype.updateFadeValue = function () {
    ...
    if (
      ...
      if (this.xyRem.length > 1) {
        let xd =
          this.xyRem[this.xyRem.length - 1][0] -
          this.xyRem[this.xyRem.length - 2][0];
        let yd =
          this.xyRem[this.xyRem.length - 1][1] -
          this.xyRem[this.xyRem.length - 2][1];
  ...
  Game_QJBullet.prototype.showRotationLastMove = function (num) {
    if (this.xyRem.length - 1 - num < 0)
      return (this.rotationMove * 180) / Math.PI;
    return (
      (this.xyRem[this.xyRem.length - 1 - num][2] * 180) / Math.PI
    );
  };
  Game_QJBullet.prototype.screenShowXLast = function (num) {
    if (this.xyRem.length - 1 - num < 0)
      return this.x - $gameMap.displayX() * 48;
    return (
      this.xyRem[this.xyRem.length - 1 - num][0] -
      $gameMap.displayX() * 48
    );
  };
  Game_QJBullet.prototype.screenShowYLast = function (num) {
    if (this.xyRem.length - 1 - num < 0)
      return this.y - $gameMap.displayY() * 48;
    return (
      this.xyRem[this.xyRem.length - 1 - num][1] -
      $gameMap.displayY() * 48
    );
  };
  Game_QJBullet.prototype.updateRotation = function () {
    ...
    if (
      this.speed > 0 &&
      [1, 2, 3, 4, 7].includes(this.moveType[0])
    ) {
      //===============================================
    ...
    if (this.moveType[0] == 6 && !this.dead) {
      ...
      let addy =
        -this.RB6S[1] *
        (data[13] * Math.sin(data[2]) -
          data[14] * (data[7] - data[6]));
      if (data[6] <= 0) {
        data[4]--;
        this.updateMoveType6(data);
      }
      ...
      QJ.BL.setPostion(this.QJBody, this.x, this.y);
      this.rotationMove = QJ.BL.calculateAngleByTwoPoint(
        0,
        0,
        addx,
        addy
    ...
    if (this.moveType[0] == 8 && !this.dead) {
      let r = this.data.initialRotation,
        m = this.moveType,
        t = this.time,
        xL = 0,
        yL = 0,
      ...
      try {
        if (m[1] == 0) {
          xL = -1 * Number(eval(m[2]));
          yL = Number(eval(m[3]));
        } else {
          let length = -1 * Number(eval(m[2])),
            rota = Number(eval(m[3]));
      ...
      let oldX = this.x,
        oldY = this.y;
      this.x =
        xL * Math.sin(r) + yL * Math.sin(r + Math.PI / 2) + this._x;
      this.y =
        -xL * Math.cos(r) - yL * Math.cos(r + Math.PI / 2) + this._y;
      this.rotationMove = QJ.BL.calculateAngleByTwoPoint(
        oldX,
        oldY,
        this.x,
    ...
    if (this.moveType[0] == 9) {
      //===============================================
      this.x =
        QJ.BL.dealX(this.data.x, null, true) +
        $gameMap.displayX() * 48;
      this.y =
        QJ.BL.dealY(this.data.y, null, true) +
        $gameMap.displayY() * 48;
      if (this.x == null || this.y == null) {
        this.setDirectDead();
        return;
  ...
  Game_QJBullet.prototype.updateMoveType6 = function (data) {
    ...
    data[13] =
      (data[8] * Math.sin(data[5])) / data[7] / Math.cos(data[2]); //v
    data[14] =
      (2 / (data[7] * data[7])) *
      (data[13] * Math.sin(data[2]) * data[7] -
        data[8] * Math.cos(data[5])); //g
    data[15] = this.x;
    data[16] = this.y;
  };
  ...
  Game_QJBullet.prototype.getSpecialTargetXy = function () {
    let character = null;
    if (this.moveType[0] == 1) character = $gamePlayer;
    if (this.moveType[0] == 2 || this.moveType[0] == 3)
      character = $gameMap.event(this.moveType[2]);
    if (this.moveType[0] == 4)
      character = $gameMap.event(
        QJ.BL.getMinEventId(this.x, this.y, this.moveType[2])
      );
    if (this.moveType[0] == 7)
      character = $gameMap.event(
        QJ.BL.getMinEventIdNobi(this.x, this.y, this.moveType[2])
      );
    if (character) {
  ...
  Game_QJBullet.prototype.update = function () {
    ...
    if (this.LMD) {
      if (
        this.x > $gameMap.maxScreenWidth ||
        this.x < 0 ||
        this.y < 0 ||
        this.y > $gameMap.maxScreenHeight
      ) {
        this.setDirectDead();
        return;
      }
    ...
    switch (this.max[0]) {
      ...
      case 2:
        if ($gameSwitches.value(this.max[1]) == this.max[2]) {
          this.setDeadDisappear();
          break;
        }
      case 3:
        if (!!eval(this.max[1]) == this.max[2]) {
          this.setDeadDisappear();
          break;
        }
    }
  ...
  Game_QJBullet.prototype.actionAndDead = function (character) {
    ...
    if (this.PierceAction || this.pierce < 0)
      this.setAction(character);
    if (this.PierceAnim || this.pierce < 0)
      this.requestAnimationQJB();
    if (this.pierce < 0) {
      this.dead = true;
      this.deadMode = 0;
  ...
  Game_QJBullet.prototype.requestAnimationQJB = function () {
    ...
    if (sprite) {
      sprite.startAnimation(
        $dataAnimations[Number(this.animation)],
        false,
        0
      );
    }
  ...
  Game_QJBullet.prototype.atkRangeTarget = function (character) {
    let index = this.target.indexOf(character),
      xs = this.x,
      ys = this.y,
      atkPow = Math.pow(this.atkRange, 2);
    if (index != -1) this.target.splice(index, 1);
    for (let i = 0; i < this.target.length; i++) {
      let tar =
        this.target[i] == 0
          ? $gamePlayer
          : $gameMap.event(this.target[i]);
      if (!tar) continue;
      if (
        Math.pow(xs - tar.boxScreenX(), 2) +
          Math.pow(ys - tar.boxScreenY(), 2) <=
        atkPow
      ) {
  ...
  Game_QJBullet.prototype.JudgeReBound = function (sat, tb, cb) {
    if (this.ReBound < 1) {
      ...
      this.ReBound--;
      this.x -=
        Math.sign(sat.overlapV.x) * (Math.abs(sat.overlapV.x) + 4);
      this.y -=
        Math.sign(sat.overlapV.y) * (Math.abs(sat.overlapV.y) + 4);
      QJ.BL.setPostion(this.QJBody, this.x, this.y);
      if (this.moveType[0] == 6) {
        //====================================
        let tbp = tb.pos,
          cbp = cb.pos;
        let du = QJ.BL.calculateAngleByTwoPoint(
          cbp.x,
          cbp.y,
          tbp.x,
          tbp.y
        ...
        else if (du < Math.PI - cb.dl)
          this.RB6S[0] = this.RB6S[0] == -1 ? 1 : -1;
        else if (du < Math.PI + cb.dl)
          this.RB6S[1] = this.RB6S[1] == -1 ? 1 : -1;
        else if (du < 2 * Math.PI - cb.dl)
          this.RB6S[0] = this.RB6S[0] == -1 ? 1 : -1;
        ...
        if (du < cb.dl) this.rotationMove = Math.PI - oldR;
          ...
          this.rotationMove = Math.PI - oldR;
        else if (du < 2 * Math.PI - cb.dl) this.rotationMove = -oldR;
        else this.rotationMove = Math.PI - oldR;
        if (this.rotationMove > 2 * Math.PI)
          this.rotationMove -= 2 * Math.PI;
  ...
  Game_QJBullet.prototype.updateCollision = function () {
    ...
    if (this.noPassDo) {
      if (
        $gameMap.noPassBoxNow(Math.floor(this.x), Math.floor(this.y))
      ) {
        this.setDead();
        return;
      }
    ...
    for (let i = 0, l = this.regions.length; i < l; i++) {
      ...
      for (let j = 0, jl = list.length; j < jl; j++) {
        ...
        if (
          sat.result &&
          this.JudgeReBound(sat, this.QJBody, list[j])
        )
          return;
      }
    }
    ...
    if (
      this.WaitBaseOnSpeed >= 0 &&
      this.speed != this.WaitBaseOnSpeed
    )
      return;
    this.target = QJ.BL.dealTarget(this.data.Target);
    //===============================================================
  ...
  Sprite_QJBullet.prototype.initialize = function (index) {
    ...
    if (typeof this.o.bitmap == "string") {
      ...
      if (frameImage) {
        ...
        ImageManager.loadBullet(this.o.bitmap).addLoadListener(
          (bit) => {
      ...
      if (data[0] == 1) {
        ...
        if (typeof data[2] === "object") {
          this.bitmap.textColor = QJ.BL.ColorGrad(
            this.bitmap,
            data[2][0],
            0,
            0,
        ...
        if (typeof data[7] === "object") {
          this.bitmap.outlineColor = QJ.BL.ColorGrad(
            ...
            mw,
            mh,
            (data[7][1] * Math.PI) / 180
          );
        } else this.bitmap.outlineColor = data[7];
        this.bitmap.outlineWidth = data[8];
        if (data[4] == 0)
          this.bitmap.drawText(data[1], 0, 0, mw, mh, "center");
        else if (data[4] == 1)
          this.bitmap.drawTextVerticalRow(
            data[1],
            0,
            0,
            mw,
  ...
  Sprite_QJBullet.prototype.updateafterImage = function () {
    ...
    if (afterImage.length > 0) {
      ...
      if (!afterImage[1].isMode) {
        ...
        if (this.o.delayDelete >= 0)
          initODe =
            ((afterImage[2] - this.o.delayDelete) / afterImage[2]) *
            initO;
      } else
        initODe =
          1 - (afterImage[2] - this.o.delayDelete) / afterImage[2];
      if (value && this.o.time > 2) {
        let w = 0;
        for (
          let ll = this.o.xyRem,
            i = ll.length - 1,
            il = Math.max(0, i - afterImage[2]),
            mu = i - il,
            dx48 = $gameMap.displayX() * 48 - 48,
            dy48 = $gameMap.displayY() * 48,
            newO,
            newx,
            newy,
            gw = Graphics.width + 96,
            gh = Graphics.height + 96;
          i > il;
          i--
        ) {
          ...
          if (afterImage[1].isMode) {
            if (this.o.delayDelete >= 0)
              newO =
                (afterImage[1].getTar(ll.length - 1 - i) / 255) *
                initODe;
          ...
          if (
            ...
            this.particleParent.drawAfterImage(
              newx,
              newy,
              ll[i][2],
              ll[i][5],
    ...
    for (let i of this.o.Particles) {
      ...
      if (i.count == 0) {
        ...
        for (let j = i.num; j > 0; j--) {
          this.particleParent.addChildrenAtId(
            new Sprite_QJY(this, [2, i], this.o)
          );
        }
        i.count = i.wait;
      } else i.count--;
  ...
  Sprite_QJY.prototype.initialize = function (parent, data, buttle) {
    ...
    if (this.bitType == 1) {
      ...
      else if (buttle.moveType[0] == 5 || buttle.moveType[0] == 8)
        this.rotation = buttle.rotationMove;
      ...
      this.rotation =
        parent.rotation +
        this.data.dir +
        Math.random() * this.data.dirOffset * 2 -
        this.data.dirOffset;
      //=======================================
      this.opacity =
        ((this.data.opacityMax - this.data.opacityMin) *
          Math.random() +
          this.data.opacityMin) *
        255;
      ...
      this.sizeManager = [
        0,
        10,
        ((this.data.scaleMax - this.data.scaleMin) * Math.random() +
          this.data.scaleMin) /
          10,
      ];
      ...
      if (frameImage) {
        ...
        this.dymaticBitmap = [
          0,
          Number(data[0]),
          this.baseTexture.width / Number(data[0]),
          0,
          Number(data[1]),
          this.baseTexture.height,
        ];
        this.setFrame(
          this.dymaticBitmap[0] * this.dymaticBitmap[2],
          0,
          this.dymaticBitmap[2],
          this.dymaticBitmap[5]
        );
      } else
        this.setFrame(
          0,
  ...
  Sprite_QJY.prototype.updateBaseData = function () {
    if (this.bitType == 1) {
      ...
      if (this.lineMove) {
        ...
        try {
          if (this.mTFT == 0) {
            xL = -1 * Number(eval(m[0]));
            yL = Number(eval(m[1]));
          } else {
            let length = -1 * Number(eval(m[0])),
              rota = Number(eval(m[1]));
            xL = length * Math.cos(rota);
            yL = length * Math.sin(rota);
          }
        } catch (e) {
        ...
        this.x =
          xL * Math.sin(r) +
          yL * Math.sin(r + Math.PI / 2) +
          this._x -
          $gameMap.displayX() * 48;
        this.y =
          -xL * Math.cos(r) -
          yL * Math.cos(r + Math.PI / 2) +
          this._y -
          $gameMap.displayY() * 48;
      }
      //=============================================
  ...
  Sprite_QJY.prototype.createTexture = function (data) {
    ...
    if (data[0] == 1) {
      ...
      let bitmap = ImageManager.loadBullet(data[1].img),
        w = bitmap.width,
        h = bitmap.height;
      lsCanvas.width = w;
      lsCanvas.height = h;
  ...
  Game_QJLaser.prototype.setBase = function () {
    ...
    this.z = this.data.z;
    this.rotationAuto =
      ((this.data.RotationAuto - 360) * Math.PI) / 180;
    //===============================================
  ...
  Game_QJLaser.prototype.updateXYR = function (ifInit) {
    ...
    for (
      let i = 0,
        ...
        dx = $gameMap.displayX(),
        dy = $gameMap.displayY(),
        w = Math.sin(this.rotation),
        h = -Math.cos(this.rotation);
      rbnum < this.ReBound;
      j++
    ) {
      if (j >= this.MaxLength) {
      ...
      if (
        !(
          this.regions.includes($gameMap.regionId(x, y)) ||
          this.terrains.includes($gameMap.terrainTag(x, y)) ||
          (this.noPassDo && !$gameMap.noPassBoxNow(x, y))
        )
      )
        continue;
      //找到对应格子的中心点
      x = (x - dx) * 48 + 24;
      y = (y - dy) * 48 + 24;
      let k = Math.tan(il[i][2] - Math.PI / 2),
        b = il[i][1] - k * il[i][0];
      let judgeLsit;
  ...
  Game_QJLaser.prototype.updateAtk = function () {
    ...
    let judgeBody = null;
    for (
      let ll = this.lineList, i = 0, il = ll.length - 1;
      i < il;
      i++
    ) {
      let len = Math.sqrt(
      ...
      judgeBody.setAngle(
        QJ.BL.calculateAngleByTwoPoint(
          ll[i][0],
          ll[i][1],
          ll[i + 1][0],
          ll[i + 1][1]
  ...
  Sprite_QJLaser.prototype.refresDymaticBitmapLine = function () {
    ...
    if (this.dymaticBitmapLine[3] == this.dymaticBitmapLine[4]) {
      ...
      if (this.dymaticBitmapLine[0] == this.dymaticBitmapLine[1])
        this.dymaticBitmapLine[0] = 0;
      this.drawRectangleLine = [
        this.dymaticBitmapLine[0] * this.dymaticBitmapLine[2],
        0,
        this.dymaticBitmapLine[2],
        this.dymaticBitmapLine[5],
      ];
    }
  };
  Sprite_QJLaser.prototype.refresDymaticBitmapPoint = function () {
    ...
    if (this.dymaticBitmapPoint[3] == this.dymaticBitmapPoint[4]) {
      ...
      if (this.dymaticBitmapPoint[0] == this.dymaticBitmapPoint[1])
        this.dymaticBitmapPoint[0] = 0;
      this.drawRectanglePoint = [
        this.dymaticBitmapPoint[0] * this.dymaticBitmapPoint[2],
        0,
        this.dymaticBitmapPoint[2],
        this.dymaticBitmapPoint[5],
      ];
    }
  };
  Sprite_QJLaser.prototype.update = function () {
    ...
    //========================================
    for (
      let i = 0, bit1, bit2, il = this.o.ReBound, lll = ll.length;
      i < il;
      i++
    ) {
      //==========================
  ...
  Game_QJTwoPoint.prototype.updateXYR = function () {
    ...
    this.rotation = QJ.BL.calculateAngleByTwoPoint(
      this.x,
      this.y,
      this.tarX,
      this.tarY
    );
    this.twoPointLength = Math.sqrt(
      (this.x - this.tarX) * (this.x - this.tarX) +
        (this.y - this.tarY) * (this.y - this.tarY)
    );
  ...
  QJ.BL.box = function (x, y, boxType) {
    ...
    if (boxType[0] == 0) {
      ...
      body = new SATPolygon(new SATVector(x, y), [
  ...
  Game_Event.prototype.steupTarPageQB = function (value) {
    if (!!this.event().pages[value - 1])
      this._forceInterpreterQB.push(
        new Game_InterpreterForceQBEvent(value - 1)
      );
  };
  const QB_Game_Event_updateParallel =
    ...
    for (let i = 0, l = this._forceInterpreterQB.length; i < l; i++) {
      ...
      if (!this._forceInterpreterQB[i].isRunning()) {
        this._forceInterpreterQB[i].setup(
          this.event().pages[this._forceInterpreterQB[i].pageIndex]
            .list,
          this._eventId
        );
      }
  ...
  //Common Event
  //=============================================================================
  QJ.BL.callCommonEvent = function (
    listvalue,
    eid,
    bp,
    bulletCanUseData
  ...
  Game_Map.prototype.steupTarPageQB = function (
    value,
    eid,
    bp,
    bulletCanUseData
    ...
    if (!!$dataCommonEvents[value])
      this._forceInterpreterQB.push(
        new Game_InterpreterForceQBCommonEvent(
          value,
          eid,
          bp,
          bulletCanUseData
  ...
  QJ.BL.dealInitialRotation = function (data, event, x, y) {
    ...
    try {
      //======================================
      data = data.replace(/PD(\[\])*/gi, (d) => {
        return (
          (QJ.BL.calculateAngleByDirection($gamePlayer.direction()) *
            180) /
          Math.PI
        );
      });
      data = data.replace(/EV\[([^\],]*)\]/gi, (d, s1) => {
        return (
          (QJ.BL.calculateAngleByTwoPoint(
            x,
            y,
            $gameMap
              .event($gameVariables.value(Number(s1)))
              .boxScreenSubRealX(),
            $gameMap
              .event($gameVariables.value(Number(s1)))
              .boxScreenSubRealY()
        ...
        (d, s1, s2) => {
          return (
            (QJ.BL.calculateAngleByTwoPoint(
              ...
              Number(s2) * tileSize + 24 + $gameMap.displayY()
            ) *
              180) /
            Math.PI
          );
      ...
      //======================================
      data = data.replace(/P(\[\])+/gi, (d) => {
        return (
          (QJ.BL.calculateAngleByTwoPoint(
            x,
            y,
            $gamePlayer.boxScreenSubRealX(),
            $gamePlayer.boxScreenSubRealY()
          ) *
            180) /
          Math.PI
        );
      });
      data = data.replace(/M(\[\])+/gi, (d) => {
        return (
          (QJ.BL.calculateAngleByTwoPoint(
            x,
            y,
            TouchInput.x + $gameMap.displayX(),
            TouchInput.y + $gameMap.displayY()
          ) *
            180) /
          Math.PI
        );
      });
      data = data.replace(/D\[([^\],]+)\]/gi, (d, s1) => {
        return (
          (QJ.BL.calculateAngleByDirection(
            s1 == 0
              ? event.direction()
              : $gameMap.event(Number(s1)).direction()
          ) *
            180) /
          Math.PI
        );
      });
      data = data.replace(/E\[([^\],]+)\]/gi, (d, s1) => {
        return (
          (QJ.BL.calculateAngleByTwoPoint(
            x,
            y,
            $gameMap.event(Number(s1)).boxScreenSubRealX(),
            $gameMap.event(Number(s1)).boxScreenSubRealY()
          ) *
            180) /
          Math.PI
        );
      });
      data = data.replace(/G\[([^\],]+)\]/gi, (d, s1) => {
        let eventData = $gameMap.event(
          QJ.BL.getMinEventId(
            x + $gameMap.displayX() * 48,
            y + $gameMap.displayY() * 48,
            s1
          )
        );
        return (
          (QJ.BL.calculateAngleByTwoPoint(
            x,
            y,
            eventData.boxScreenSubRealX(),
            eventData.boxScreenSubRealY()
          ) *
            180) /
          Math.PI
        );
      });
      data = data.replace(/N\[([^\],]+)\]/gi, (d, s1) => {
        let eventData = $gameMap.event(
          QJ.BL.getMinEventIdNobi(
            x + $gameMap.displayX() * 48,
            y + $gameMap.displayY() * 48,
            s1
          )
      ...
      data = data.replace(/B\[([^\]]+),([^\]]+)\]/gi, (d, s1, s2) => {
      ...
      data = data.replace(
        ...
        (d, s1, s2, s3, s4) => {
          if (GroupRandomReLoad) {
            ...
            s2 = QJ.BL.dealX(s2, null, true);
            s3 = QJ.BL.dealY(s3, null, true);
            let eventsData = QJ.BL.getGroupIdInRange(
              s1,
              Number(s2),
              Number(s3),
              Number(s4)
  ...
  QJ.BL.dealX = function (data, event, fastRead) {
    ...
    try {
      ...
      data = data.replace(/E\[([^\],]+)\]/gi, (d, s1) => {
        let tar =
          Number(s1) == 0 ? event : $gameMap.event(Number(s1));
        return tar.boxScreenSubRealX();
      });
      data = data.replace(/B\[([^\],]+)\]/gi, (d, s1) => {
        let tar = $gameMap.bullet(Number(s1));
      ...
      //======================================
      data = eval(data);
      if (data == null || isNaN(Number(data)) || (!data && data != 0))
        return null;
      return Number(data);
      //======================================
    } catch (e) {
  ...
  QJ.BL.dealMax = function (data, event) {
    ...
    if (typeof data == "number" || !isNaN(Number(data))) {
      ...
      return [
        2,
        Number(detail[0]) == 0 ? event._eventId : Number(detail[0]),
        detail[1],
        eval(detail[2]),
      ];
    } else if (data[0] == "S") {
    ...
    try {
      ...
      if (movetype[1] == "E" && movetype[2] == "V") {
        ...
        return [
          3,
          Number(detail[0]),
          $gameVariables.value(Number(detail[1])),
        ];
      }
      if (movetype[1] == "E") {
        let data = movetype.match(/\[[^\]]*\]/i);
    ...
    try {
      ...
      for (let i of data) {
        if (i[0] == "E" && i[1] == "V") {
          ...
          if (!detail) continue;
          tarList = tarList.concat(
            QJ.BL.getCommentId("[" + detail + "]")
          );
        }
      }
      return tarList;
  ...
  QJ.BL.startAction = function (bullet, tarCharacter) {
    let dataList = bullet.action,
      eid = 0;
    if (tarCharacter) {
      if (tarCharacter == $gamePlayer) eid = -1;
      else if (tarCharacter._eventId > 0) eid = tarCharacter._eventId;
    }
    let bulletX = bullet.screenShowX(),
      bulletY = bullet.screenShowY(),
      bulletR = bullet.rotation;
    ...
    for (let data of dataList) {
      if (data[0] == "C" && data[1] == "P" && eid != 0) {
        ...
        if (Number(detail[0]) <= 0 || !Number.isInteger(detail[0]))
          return;
  ...
  //Shoot order.
  //=============================================================================
  QJ.BL.Shooter_FlameThrower = function (
    data,
    minScale,
    maxScale,
    offsetDir,
    ...
    for (let i = 0; i < num; i++) {
      ...
      bullet.initialRotation =
        (data.initialRotation != undefined
          ? data.initialRotation
          : "PD[]") +
        "+" +
        (Math.random() * offsetDir * 2 - offsetDir);
  ...
  QJ.BL.Shooter_Gain = function (data, type, id, num) {
    ...
    data.initialRotation =
      60 * Math.random() - 30 + (Math.random() > 0.5 ? 90 : 270);
    data.RotationAuto = 0;
    ...
    if (type == 3 || type == "gold") {
      data.Img = [2, id];
      if (
        Imported.MOG_TreasurePopup &&
        Moghunter.trpopup_GoldVisible === "true" &&
        $gameSystem._trspupVisible
      ) {
        if (num > 0 || (num < 0 && Moghunter.trpopup_LostItemVisible))
          data.Action = [
            "T[$gameParty.gainGold(" +
              num +
              ");" +
      ...
      if (type == 0 || type == "item")
        item = "$dataItems[" + id + "]";
      else if (type == 1 || type == "weapon")
        item = "$dataWeapons[" + id + "]";
      else if (type == 2 || type == "armor")
        item = "$dataArmors[" + id + "]";
      else {
  ...
  QJ.BL.Shooter_CharacterAtk = function (character, data, of, arc) {
    ...
    let tar =
      character == -1
        ...
        : character == 0
        ? QJ.BL.getEvent()
        : $gameMap.event(character);
    if (!tar) return;
    //====================================
    let orginRotation =
      (QJ.BL.calculateAngleByDirection(tar.direction()) * 180) /
      Math.PI;
    let ofx = of[tar.direction() - 2],
      ofy = of[tar.direction() - 1];
    //====================================
    if (arc) {
      ...
      for (let i = arc[0]; i < arc[1]; i += delta) {
        let bullet = {
          initialRotation:
            orginRotation + i + (Math.random() - 0.5) * arc[3],
  ...
  QJ.BL.Shooter_P = function (
    ...
    for (
      let i = 0,
        il = number - 1,
        ilm = Math.max(
          (Math.sqrt(2 - 2 * Math.cos((2 * Math.PI) / edgeNum)) * r) /
            (number - 1),
          1
        ),
        c = Math.PI * (0.5 - 1 / edgeNum),
        fan = false,
        halfil = (il + 1) / 2;
      i < il;
      i++
  ...
  QJ.BL.Shooter_C = function (
    ...
    //====================================
    let event = QJ.BL.getEvent();
    let ro = QJ.BL.dealInitialRotation(
      rotation,
      event,
      QJ.BL.dealX(x, event, false),
      QJ.BL.dealY(y, event, false)
    );
  ...
  QJ.BL.Shooter_ArcRange = function (initialRotation, data, arc) {
    //====================================
    for (
      let i = arc[0], delta = (arc[1] - arc[0]) / arc[2];
      i < arc[1];
      i += delta
    ) {
      data["initialRotation"] =
        initialRotation + "+" + (i + (Math.random() - 0.5) * arc[3]);
      QJ.BL.Shoot(JsonEx.makeDeepCopy(data));
    }
    //====================================
  };
  QJ.BL.Shooter_HandGrenade = function (
    data,
    oneLength,
    oneTime,
    maxReBound
  ...
  QJ.BL.addShadow = function (character, data, time, delta) {
    ...
    //====================================
    tar.addShadowCircle(
      character == 0 ? tar._eventId : character,
      data,
      QJ.BL.dealTime(time),
      delta
    );
  ...
  QJ.BL.Text = function (
    ...
    let WAndH = bitmapData.getWAndH(text, fontsize),
      box;
    if (d == 2 || d == 8) {
      box =
        "R[" +
    ...
    let bullet = {
      ...
      x:
        tar.boxScreenSubX() +
        (d == 4
          ? (((-text.length * (fontsize - 4)) / 72) * 96) / 2
          : d == 6
          ? (((text.length * (fontsize - 4)) / 72) * 96) / 2
          : 0),
      y:
  ...
  QJ.BL.Shoot = function (data, bo) {
    ...
    bullet["MoveType"] = QJ.BL.dealMoveType(
      bullet["MoveType"],
      event
    );
    if (bullet["MoveType"][0] == 9) {
      ...
      bullet["initialRotation"] = QJ.BL.dealInitialRotation(
        bullet["initialRotation"],
        event,
        bullet["x"],
        bullet["y"]
    ...
    bullet["CollisionBox"] = QJ.BL.dealCollisionBox(
      bullet["CollisionBox"]
    );
    if (
      typeof bullet["Img"] == "object" &&
      bullet["Img"][0] == 0 &&
      bullet["Img"][1] == 0
    )
  ...
  QJ.BL.Laser = function (data) {
    ...
    if (event) {
      if (typeof bullet.x == "string")
        bullet.x = bullet.x.replace(
          /E\[0\]/gi,
          "E[" + event._eventId + "]"
        );
      if (typeof bullet.y == "string")
        bullet.y = bullet.y.replace(
          /E\[0\]/gi,
          "E[" + event._eventId + "]"
        );
      if (typeof bullet.initialRotation == "string")
        bullet.initialRotation = bullet.initialRotation.replace(
          /D\[0\]/gi,
          "D[" + event._eventId + "]"
        );
    }
  ...
  QJ.BL.dealCharacter = function (data) {
    if (typeof data == "number") {
      if (data == -1) return $gamePlayer;
        ...
        return QJ.BL.getEvent() ? QJ.BL.getEvent() : null;
  ...
  QJ.BL.TwoPoint = function (x1, y1, x2, y2, data) {
    ...
    bullet.z = QJ.BL.dealZ(bullet.z, QJ.BL.getEvent(), false);
    if (event) {
      if (typeof bullet.x1 == "string")
        bullet.x1 = bullet.x1.replace(
          /E\[0\]/gi,
          "E[" + event._eventId + "]"
        );
      if (typeof bullet.y1 == "string")
        bullet.y1 = bullet.y1.replace(
          /E\[0\]/gi,
          "E[" + event._eventId + "]"
        );
      if (typeof bullet.x2 == "string")
        bullet.x2 = bullet.x2.replace(
          /E\[0\]/gi,
          "E[" + event._eventId + "]"
        );
      if (typeof bullet.y2 == "string")
        bullet.y2 = bullet.y2.replace(
          /E\[0\]/gi,
          "E[" + event._eventId + "]"
        );
    }
  ...
  //Event.
  //=============================================================================
  const QJBL_Game_Event_initMembers =
  ...
  Game_Map.prototype.refreshUpdateBoxData = function () {
    ...
    for (let i of $gameMap.events()) {
      if (i.laserObstacle)
        nOBN[Math.floor(i.x + 0.5)][Math.floor(i.y + 0.5)] = false;
    }
    //====================================
  ...
  Game_Map.prototype.update = function (sceneActive) {
    ...
    for (let i = 0, l = this._forceInterpreterQB.length; i < l; i++) {
      ...
      if (!this._forceInterpreterQB[i].isRunning()) {
        this._forceInterpreterQB[i].setup(
          $dataCommonEvents[this._forceInterpreterQB[i].commonEventId]
            .list,
          this._forceInterpreterQB[i].EID > 0
            ? this._forceInterpreterQB[i].EID
            : 0
        );
      }
      this._forceInterpreterQB[i].update();
  ...
  Game_Map.prototype.addBullet = function (bullet, type) {
    if (showWarn) {
      if ($gameMap._aliveBullet >= maxbullet) {
        console.warn(
          "The number of bullets has reached the limit." +
            "And the number is" +
            $gameMap._aliveBullet +
            "."
        );
    ...
    let bulletsTarget;
    if (!type)
      bulletsTarget = new Game_QJBullet(
        bullet,
        this._mapBullets.length
      );
    else if (type == 1)
      bulletsTarget = new Game_QJLaser(
        bullet,
        this._mapBullets.length
      );
    else if (type == 2)
      bulletsTarget = new Game_QJTwoPoint(
        bullet,
        this._mapBullets.length
      );
    this._mapBullets.push(bulletsTarget);
    if (!this._mapBullets[this._mapBullets.length - 1].dead)
      SceneManager._scene._spriteset.createBullet(
        this._mapBullets.length - 1,
        type
      );
  ...
  Game_Map.prototype.findBulletSprite = function (data) {
    ...
    if (data.data.z == "T") {
      contain =
        SceneManager._scene._spriteset._parallaxBulletContainer;
  ...
  QJ.BL.callCE = function (id, bullet) {
    QJ.BL.callCommonEvent(id, 0, [], {
      x: bullet.screenShowX(),
      y: bullet.screenShowY(),
    });
  };
  ...
  //Bitmap
  //=============================================================================
  Bitmap.prototype.drawTextChangeRotation = function (
    text,
    x,
    y,
    maxWidth,
    ...
    if (text !== undefined) {
      var tx = x;
      var ty =
        y + lineHeight - (lineHeight - this.fontSize * 0.7) / 2;
      var context = this._context;
  ...
  Bitmap.prototype.drawTextVerticalRow = function (
    text,
    x,
    y,
    maxWidth,
  ...
  //=============================================================================
  Game_InterpreterForceQBEvent.prototype = Object.create(
    Game_Interpreter.prototype
  );
  Game_InterpreterForceQBEvent.prototype.constructor =
    Game_InterpreterForceQBEvent;
  Game_InterpreterForceQBEvent.prototype.initialize = function (
    pageIndex
  ) {
  ...
  Game_InterpreterForceQBEvent.prototype.terminate = function () {
    $gameMap
      .event(this.eventId())
      ._forceInterpreterQB.splice(
        $gameMap
          .event(this.eventId())
          ._forceInterpreterQB.indexOf(this),
        1
      );
  ...
  //=============================================================================
  Game_InterpreterForceQBCommonEvent.prototype = Object.create(
    Game_Interpreter.prototype
  );
  Game_InterpreterForceQBCommonEvent.prototype.constructor =
    Game_InterpreterForceQBCommonEvent;
  Game_InterpreterForceQBCommonEvent.prototype.initialize = function (
    id,
    eid,
    bp,
    bulletCanUseData
  ...
  Game_InterpreterForceQBCommonEvent.prototype.terminate =
    function () {
      $gameMap._forceInterpreterQB.splice(
        $gameMap._forceInterpreterQB.indexOf(this),
        1
      );
      Game_Interpreter.prototype.terminate.call(this);
    };
  ...
  QJ.BL.calculateAngleByTwoPoint = function (x, y, ex, ey) {
    ...
    if (ex > x && ey > y)
      ro = Math.PI - Math.atan((x - ex) / (y - ey));
    if (ex < x && ey > y)
      ro = Math.PI - Math.atan((x - ex) / (y - ey));
    if (ex < x && ey < y)
      ro = 2 * Math.PI - Math.atan((x - ex) / (y - ey));
  ...
  QJ.BL.getMinEventIdNobi = function (x, y, nobi) {
    ...
    for (let i in basedata) {
      let length =
        (basedata[i].boxScreenX() - x) *
          (basedata[i].boxScreenX() - x) +
        (basedata[i].boxScreenY() - y) *
          (basedata[i].boxScreenY() - y);
      if (length < min) {
  ...
  QJ.BL.dealCollisionBox = function (data) {
    ...
    if (data[0] == "C") {
      ...
      if (
        !detail ||
        isNaN(Number(detail[0])) ||
        isNaN(Number(detail[1]))
      )
        return null;
  ...
  //System.
  //=============================================================================
  const QJB_Game_Temp_setDestination =
  ...
  const QJB_Game_Interpreter_executeCommand =
  ...
  //=============================================================================
  QJFrame.prototype.initialize = function (
    name,
    orginData,
    dataType,
    noFadeCopy
    ...
    if (typeof orginData == "string" && orginData.includes("~")) {
      ...
      for (let i = 0, il = data.length, detail; i < il; i++) {
        if (data[i].includes("|")) {
          ...
          if (noFadeCopy) {
            for (
              let i = this.m, ll = Number(detail[0]);
              i < ll;
              i++
            ) {
              this.d[i] = num;
          ...
          if (dataType == 0) {
            ...
            for (let j = 1; j <= fadeT; j++) {
              this.d[this.m + j] = QJ.BL.rgbToHex({
                r: Math.floor(
                  last.r + ((num.r - last.r) * j) / fadeT
                ),
                g: Math.floor(
                  last.g + ((num.g - last.g) * j) / fadeT
                ),
                b: Math.floor(
                  last.b + ((num.b - last.b) * j) / fadeT
                ),
              });
            }
            this.m += fadeT;
          ...
          if (dataType == 0) {
            ...
            for (let j = 1; j <= fadeT; j++) {
              this.d[this.m + j] =
                num -
                (num - last) * Math.sqrt(1 - Math.pow(j / fadeT, 2));
            }
            this.m += fadeT;
            this.d[this.m] = num;
          } else if (dataType == 1) {
      ...
      if (dataType == 0) num = Number(orginData);
        ...
        num = (Number(orginData) * Math.PI) / 180;
      this.d[this.m] = num;
    }
  };
  ...
  const QJB_Spriteset_Map_createParallax =
  ...
  const QJB_Spriteset_creatBullets =
  ...
  Spriteset_Map.prototype.createCharacters = function () {
    ...
    for (let i = 0; i < $gameMap._mapBullets.length; i++) {
      if ($gameMap._mapBullets[i])
        this.createBullet(i, $gameMap._mapBullets[i].bulletMode);
    }
  };
  const QJB_Spriteset_Base_createTimer =
    Spriteset_Base.prototype.createTimer;
  ...
  Spriteset_Map.prototype.createBullet = function (index, type) {
    let data = $gameMap._mapBullets[index],
      spriteData;
    ...
    if (data.data.z == "T") {
      ...
      spriteData.particleParent =
        this._parallaxBulletContainerParticle;
    } else if (data.data.z == "M") {
  ...
  Sprite_QJContainer.prototype = Object.create(
  ...
  Sprite_QJContainer.prototype.addChildrenAtId = function (
    bulletSprite
  ) {
  ...
  Sprite_QJContainer.prototype.drawAfterImage = function (
    x,
    y,
    r,
    c,
  ...
  Sprite_QJPContainer.prototype = Object.create(
  ...
  //
  //=============================================================================
  const BL_Game_Variables_initialize =
  ...
  QJ.BL.initParam = function (gameVariables) {
    if (!gameVariables._playerInitBox) {
      gameVariables._playerInitBox =
        String(parameters["playerInitBox"]) || "C[24]";
    }
    if (!gameVariables._playerInitBoxOffsetX) {
      gameVariables._playerInitBoxOffsetX =
        Number(parameters["playerInitBoxOffsetX"]) || 0;
    }
    if (!gameVariables._playerInitBoxOffsetY) {
      gameVariables._playerInitBoxOffsetY =
        Number(parameters["playerInitBoxOffsetY"]) || 0;
    }
    if (!gameVariables._eventInitBox) {
      gameVariables._eventInitBox =
        String(parameters["eventInitBox"]) || "C[24]";
    }
    if (!gameVariables._eventInitBoxOffsetX) {
      gameVariables._eventInitBoxOffsetX =
        Number(parameters["eventInitBoxOffsetX"]) || 0;
    }
    if (!gameVariables._eventInitBoxOffsetY) {
      gameVariables._eventInitBoxOffsetY =
        Number(parameters["eventInitBoxOffsetY"]) || 0;
    }
  };
  QJ.BL.setDefaultEventBox = function (
    collisionBox,
    offsetx,
    offsety
  ) {
  ...
  Game_CharacterBase.prototype.boxScreenSubX = function () {
    return (
      (this._x + 0.5 - $gameMap.displayX()) * tileSize +
      this.boxOffsetX
    );
  };
  Game_CharacterBase.prototype.boxScreenSubY = function () {
    return (
      (this._y + 0.5 - $gameMap.displayY()) * tileSize +
      this.boxOffsetY -
      this.boxShiftY()
    );
  };
  Game_CharacterBase.prototype.boxScreenSubRealX = function () {
    return (
      (this._realX + 0.5 - $gameMap.displayX()) * tileSize +
      this.boxOffsetX
    );
  };
  Game_CharacterBase.prototype.boxScreenSubRealY = function () {
    return (
      (this._realY + 0.5 - $gameMap.displayY()) * tileSize +
      this.boxOffsetY -
      this.boxShiftY()
    );
  };
  ...
  Game_CharacterBase.prototype.boxScreenY = function () {
    return (
      (this._y + 0.5) * tileSize + this.boxOffsetY - this.boxShiftY()
    );
  };
  ...
  //Shadow
  //=============================================================================
  Game_Character.prototype.addShadowCircle = function (
    character,
    data,
    time,
    delta
  ...
  Game_Character.prototype.updateShadowCirccle = function () {
    ...
    if (sc[0] == 0) {
      ...
      if (QJ.BL.dealTimeBoolean(sc[3], this))
        this.shadowCircle = null;
      else {
        sc[1]--;
        if (sc[1] <= 0) {
  ...
  Game_Player.prototype.refreshBodyBox = function () {
    ...
    this.QJBody = QJ.BL.box(
      this.boxScreenX(),
      this.boxScreenY(),
      QJ.BL.dealCollisionBox(boxType)
    );
    //========================================
  };
  Game_Event.prototype.refreshBodyBox = function () {
    ...
    let content = "",
      detail;
    try {
      content = QJ.BL.getAnnotation(this);
    } catch (e) {
      content = "";
    }
    //========================================
...
Game_Event.prototype.erase = function() {
  ...
  //Box Sprite.
  //=============================================================================
  const QJC_Spriteset_Map_createLowerLayer =
  ...
  Sprite_CollisiobBox.prototype.update = function () {
    ...
    if (this.visible) {
      ...
      if ($gamePlayer.QJBody)
        this.drawBody(
          $gamePlayer.QJBody,
          this.bitmap._context,
          dx,
          dy,
          characterShow
        );
      for (
        let i = 0, el = $gameMap._events, ell = el.length;
        i < ell;
        i++
      ) {
  ...
  Sprite_CollisiobBox.prototype.drawBodies = function (
    list,
    c,
    dx,
    dy,
  ...
  Sprite_CollisiobBox.prototype.drawBody = function (
    body,
    c,
    dx,
    dy,
